				...
				<div className={classes.root}>
					<AppBar position="fixed" style={{ backgroundColor: '#208769' }}>
						<Toolbar style={{ textAlign: 'center' }}>
							<img src={logo} style={{ height: '120px', margin: 'auto' }} />
						</Toolbar>
					</AppBar>
					<Toolbar />
					<Grid
							...
							<Paper style={{ marginLeft: '20px' }}>
								<Grid container sm={12}>
									<Grid
										...
										sm={1}
										xs={1}
										style={{ backgroundColor: '#208769', paddingRight: '10px' }}
									/>
									<Grid
										item
										sm={10}
										xs={10}
										style={{ paddingTop: '10px', paddingBottom: '10px', marginleft: '15px' }}
									>
										<Typography variant="p" style={{ fontWeight: 'bold', width: '98%' }}>
											&nbsp;&nbsp;Access Distributor
										</Typography>{' '}
									</Grid>
								</Grid>
					...
					<Grid
						...
						sm={12}
						xs={12}
						style={{ bottom: 0, position: 'absolute', border: '1px solid white', width: '100%' }}
					>
						<Paper className={classes.paper}>
							<Typography variant="subtitle2"> &copy; TradeTech 2020</Typography>
						</Paper>
					</Grid>
				</div>
			);
