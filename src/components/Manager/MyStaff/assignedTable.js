...
let {managerStore:{listOfOrder,listOfUsers}}=this.props;
let getId = JSON.parse(sessionStorage.getItem('userData'))

let filterorder = listOfOrder.filter((order =>order.distributor_ID === getId.distributor_ID && order.orderStatus === 'Packing' && order.packer_ID === this.props.myId || order.distributor_ID === getId.distributor_ID && order.orderStatus === 'Dispatch' && order.packer_ID === this.props.myId))
...
export default inject("managerStore")(observer(Passign));