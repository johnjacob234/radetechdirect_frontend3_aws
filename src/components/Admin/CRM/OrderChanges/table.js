...
import {Table,TableBody,TableCell,TableContainer,TableHead,TablePagination,TableRow,
  TableSortLabel,Toolbar,Typography,Paper,Checkbox,IconButton,Tooltip,FormControlLabel,Switch,Grid} from '@material-ui/core';
...
function OrderChangesHead(props) {
...
const OrderChangesToolbar = props => {
  ...
  return (
    <div className={classes.root}>
      ...
      <Grid container xs={12}>
        <OrderChangesToolbar numSelected={selected.length} />
...
export default inject("startingStore")(observer(custTable));