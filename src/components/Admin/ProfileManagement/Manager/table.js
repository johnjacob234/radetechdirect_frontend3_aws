...
class managerTable extends Component{
  ...
  render(){
    ...
    let listofmanager = listOfUsers.filter(user => user.account_accessType === "manager")
    // console.log(listofmanager , "aw")
function createData(shop, name, address, contact, email) {
  return { shop, name, address, contact, email };
}
...
function ManagerListTableHead(props) {
...
ManagerListTableHead.propTypes = {
...
const ManagerListTableToolbar = props => {
...
ManagerListTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
};
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        ...
        <ManagerListTableToolbar numSelected={selected.length} />
        <TableContainer>
          <Table
...
export default inject("startingStore")(observer(managerTable));