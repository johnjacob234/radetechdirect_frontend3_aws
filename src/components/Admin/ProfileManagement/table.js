...
function AdminListTableHead(props) {
...
const AdminListTableToolbar = props => {
...
AdminListTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
};
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        ...
        <AdminListTableToolbar numSelected={selected.length} />
        <TableContainer>
          <Table
...
export default inject("startingStore")(observer(adminTable));